    ...
    return (
        ...
        >
            <div className='p-8'>
                ...
                {!isSubmitted ? (
                    <form onSubmit={handleSubmit}>
                        <p className='text-creme mb-6 text-center'>
                    ...
                    <div className='text-center'>
                        <motion.div
                            ...
                            className='w-16 h-16 bg-grey rounded-full flex items-center justify-center mx-auto mb-4'
                        >
            ...
            <div className='px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center'>
                <Link to={"/login"} className='text-sm text-olive hover:underline flex items-center'>
