        ...
        >
            <div className="p-8">
                ...
                <form onSubmit={handleSignUp}>
                    ...
                    <motion.button
                        className="mt-5 w-full py-3 px-4 bg-gradient-to-r from-olive to-brown text-white font-bold rounded-lg shadow-lg hover:from-grey hover:to-black focus:outline-none focus:ring-2 focus:ring-grey focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200"
